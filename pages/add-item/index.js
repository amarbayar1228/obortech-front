...
return {label: i=== 0 ?  <div style={{fontWeight: "600", fontSize: "14px", color: "#4d5057"}}>Item list </div> : <div style={{fontWeight: "600", fontSize: "14px", color: "#4d5057"}}>Group list </div>, key: i, children: i === 0? 
   <div><Item /></div> 
  :<div><GroupItem /></div>,
};
})}
