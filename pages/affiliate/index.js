      ...
      <div className={css.Split}>
        ...
        />
          ...
          <Tabs defaultActiveKey="1">
            {/* User ============================================================================================================= */}
            <TabPane tab={<span style={{display: "flex",alignItems: "center",fontSize: "17px", fontWeight: "500"}}>User</span>}key="1"> 
            </TabPane>
            {/* Company ================================================================================================= */}
            <TabPane tab={<span style={{display: "flex",alignItems: "center",fontSize: "17px", fontWeight: "500" }}>Company</span>}key="2"> 
              <div> 
              <Segmented size="middle" block 
                                  ...
                                  {e.orgId === "-" ? (
                                    <div style={{ marginTop: "5px" }}>
                                      <Modal title="Organization" visible={isModalVisibleOrgId} onOk={() => handleOkOrgId(e)} onCancel={handleCancelOrgId}>
                                        <div><Input onChange={(e) =>setOrgId(e.target.value)} placeholder="Org ID insert"/></div>
                                      </Modal>
