...
const focusInput = () =>{
 ...
 const onPressEnterF = (e) =>{
  ...
  return (
    <div style={{ fontFamily: "Roboto Condensed, sans-serif"}}> <Head><title>{basketContext.t('obortech', { ns: 'login' })}</title><meta name="description" content="Generated by create next app" /> <link rel="icon" href="img/HeaderLogo.png" /></Head>
