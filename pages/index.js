...
<Head> <title>{t('obortech', { ns: 'organization' })}</title> <meta name="description" content="Generated by create next app" /><link rel="icon" href="img/HeaderLogo.png" /></Head>
<BaseLayout pageName="home" addItemStyle={addItemStyle}>
  ...
  <div className={css.SearchCss}>  
    <div className={css.SearchInput}> 
      ...
      <Search placeholder={t('Enter your organization ID', { ns: 'organization' })} allowClear  size="large" onSearch={onSearch} enterButton status={searchStatus} ref={inputRef} onChange={searchChangeFunc} disabled={spin}/>
  ...
  <div style={{position: "absolute", bottom: "0px", width: "99.96%", background: "#D2D3D5", color: "#4d5057"}}>
  <div className={css.CrSize}> 
              <div className={css.CopyRight}>
                  <div>Copyright © 2023 OBORTECH. All Rights Reserved.</div>
                  <div>
                    <Image   alt="Obertech" src={"/img/cardnuud.png"} width={150}  height={10}/>
                  </div>
              </div>
            </div>
  </div>
